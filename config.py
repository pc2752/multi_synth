...
backing_dir = './backing/'
# log_dir = './log_f0_npss/'
log_dir = './log_f0_npss_full_dis/'
# 4 for 1000 and 1000 epoch training, 3 for just G1 output with uv, 2 for just G1 output without uv and 1 for a mixture (G1 after 1000), without numbers for both from ebeggining
val_dir = './'
feats_dir = './feats/'
